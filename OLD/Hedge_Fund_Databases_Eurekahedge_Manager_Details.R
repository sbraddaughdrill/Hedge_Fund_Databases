...
# 
# Author:  Brad
# File:    Hedge_Fund_Databases_Eurekahedge_Manager_Details.R
# Version: 1.0
# Date:    11.10.2014
# Purpose: Combine Manager Details from Eurekahedge Data
#
###############################################################################
...
Details_input <- Details_input0[grep("Manager_Details",Details_input0[,"file_name"]),]
...
# 
# Details_files <- c("EurekahedgeHF_EXCEL_2014Apr_Data_Manager_Details","EurekahedgeHF_EXCEL_2013Feb_Data_Manager_Details",
#                    "EurekahedgeHF_EXCEL_2012Feb_Data_Manager_Details","EurekahedgeHF_EXCEL_2011Feb_Data_Manager_Details",
#                    "EurekahedgeHF_EXCEL_2010Feb_Data_Manager_Details","EurekahedgeHF_EXCEL_2009Feb_Data_Manager_Details",
#                    "EurekahedgeHF_EXCEL_2008Feb_Data_Manager_Details","EurekahedgeHF_EXCEL_2007Feb_Data_Manager_Details")
# 
...
Details_concatenate_location_col <- Details_concatenate_nonid_cols[grep("Country|Other_Offices", Details_concatenate_nonid_cols)]
Details_concatenate_nonlocation_col <- Details_concatenate_nonid_cols[!(Details_concatenate_nonid_cols %in% c(Details_concatenate_location_col))]

Details_concatenate_company_col <- Details_concatenate_nonlocation_col[grep("Company", Details_concatenate_nonlocation_col)]
Details_concatenate_noncompany_col <- Details_concatenate_nonlocation_col[!(Details_concatenate_nonlocation_col %in% c(Details_concatenate_company_col))]

Details_concatenate <- Details_concatenate[,c(Details_concatenate_id_cols,Details_concatenate_noncompany_col,
                                              Details_concatenate_company_col,Details_concatenate_location_col)]

rm2(Details_concatenate_all_cols)
rm2(Details_concatenate_id_cols,Details_concatenate_nonid_cols)
rm2(Details_concatenate_location_col,Details_concatenate_nonlocation_col)
rm2(Details_concatenate_company_col,Details_concatenate_noncompany_col)
...
write.csv(Details_common_colnames, file=paste(common_col_folder_path,"//","EurekahedgeHF_Manager_Details_cols",".csv",sep=""),row.names=FALSE)
...
write.csv(Details_concatenate, file=paste(final_folder_path,"//","EurekahedgeHF_Manager_Details",".csv",sep=""),row.names=FALSE)
